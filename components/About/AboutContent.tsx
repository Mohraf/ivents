      ...
      <div className="bg-white min-h-96 text-black md:pb-5 pb-10">
        ...
        >
          ...
          <p className="md:px-32 px-4 text-black md:font-extralight md:text-xl text-base font-thin md:text-start text-center mt-8">
            ...
            region. iVENTS by GEiCO's proficiency in the planning, management
            and execution of conferences, exhibitions and coorporate events is
            unrivaled.
          </p>

          <p className="md:px-32 px-4 text-black md:font-extralight md:text-xl text-base font-thin md:text-start text-center mt-4">
            Working as an extension of your marketing and communication teams,
            our collection of strategists, technicians, creatives and magicians
            target to deliver ivent-ful experiences that resonate with your
            audience, confident to meet all your requirements with expedience
            and a value-for-money guarantee.
          </p>
        ...
        <div className="grid md:grid-cols-3 grid-cols-1 gap-8 mt-12">
          <div className="p-6 bg-slate-100 rounded-lg" data-aos="fade-up">
            ...
            <p className="mt-2 text-gray-600">
              A flexible team with years of industry knowledge, focused on
              delivering high-quality events within your budget
            </p>
          </div>
          ...
          >
            ...
            <p className="mt-2 text-gray-600">
              Digital solutions that enhance event planning, execution, and
              experience, from 3D Designs to attendee tracking.
            </p>
          </div>
          ...
          >
            ...
            <p className="mt-2 text-gray-600">
              Clear, honest and well detailed information about costs, ensuring
              there are no hidden charges or unexpected fees.
            </p>
          </div>
          ...
          >
            ...
            <p className="mt-2 text-gray-600">
              A winning experience backed by 100% commitment from the 2023-2024
              recipients of the Huawei Excellent Marketing Service Partner Award
            </p>
          </div>
          ...
          >
            <div className="flex">
              <FaPlus className="w-12 h-12 text-gray-700" />{" "}
              <FaPlus className="w-12 h-12 text-gray-700" />
            </div>
            <h4 className="text-xl font-semibold mt-4">Advantage</h4>
            <p className="mt-2 text-gray-600">
              Leverage our established relationships with suppliers/venues for
          ...
          >
            ...
            <h4 className="text-xl font-semibold mt-4">
              360degrees Event Management
            </h4>
            <p className="mt-2 text-gray-600">
              24/7, end-to-end dedicated support throughout your event journey,
              allowing you to focus on your vision and enjoy total peace of
              mind.
            </p>
          </div>
        </div>
