...
const Intro = () => {
  return (
    <>
        ...
        <div className='mb-10'>
            <div className='flex row justify-start gap-10 px-10 py-4'>
                <h3>iVENTS by <span className='text-amber-400'>GEiCO</span></h3>
                <Link href="/" className='bg-green-600 p-3 rounded justify-center text-center items-center'>OUR COMPANY PROFILE</Link>
            </div>
